...
class TransformTest {
    ...
    fun mirrorPointAcrossXAxis() {
        ...
        assertClose(m.x, 3.0); assertClose(m.y, -4.0)
    }
    ...
    fun rotateSegment90AboutOrigin() {
        ...
        assertClose(s.b.x, 0.0); assertClose(s.b.y, 20.0)
    }
    ...
    fun scaleCircleAboutOrigin() {
        ...
        assertClose(s.center.x, 20.0); assertClose(s.center.y, 0.0)
    ...
    fun mirrorArcFlipsOrientation() {
        ...
        assertClose(mirrored.center.x, -10.0); assertClose(mirrored.center.y, 0.0)
