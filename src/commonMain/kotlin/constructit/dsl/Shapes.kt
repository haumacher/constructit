...
fun <A, R> Construction.instance(macro: Macro<A, R>, instanceId: String, args: A): R =
...
val roundedRect = Macro<RoundedRectArgs, RoundedRect>("roundedRect") { a ->
    ...
    val nix = neg(ix); val niy = neg(iy)
    val nhw = neg(hw); val nhh = neg(hh)
    ...
    val segments = listOf(
        segment(pTopL, pTopR),   // top
        segment(pRightT, pRightB), // right
        segment(pBotR, pBotL),   // bottom
        segment(pLeftB, pLeftT), // left
    )
    val arcs = listOf(
...
val standardRect = Macro<StandardRectArgs, RoundedRect>("standardRect") { a ->
...
val boltCircle = Macro<BoltCircleArgs, BoltCircle>("boltCircle") { a ->
...
val holePattern = Macro<HolePatternArgs, HolePattern>("holePattern") { a ->
