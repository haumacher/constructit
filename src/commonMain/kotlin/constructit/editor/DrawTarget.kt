...
interface DrawTarget {
    fun begin(widthPx: Double, heightPx: Double)
    fun polyline(points: List<Vec2>, style: Style)
    fun circle(center: Vec2, radiusPx: Double, style: Style)
    fun dot(center: Vec2, radiusPx: Double, color: String)
    fun end()
}
